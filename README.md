...
<Group description="Body">
  ...
  <Variable name="body.text.color" description="Color" type="color" default="#292929"  value="#000000"/>
  <Variable name="body.link.color" description="Link color" type="color" default="#25a186"  value="#235b9a"/>
  <Variable name="body.link.visited.color" description="Visited link color" type="color" default="$(body.link.color)"  value="#235b9a"/>
  <Variable name="body.link.hover.color" description="Link Hover Color" type="color" default="$(body.link.color)"  value="#235b9a"/>
...
<Group description="Featured post" selector=".heroPost">
  <Variable name="heropost.main.background.color" description="Featured post main background color" type="color" default="#25a186"  value="#235b9a"/>
  ...
  <Variable name="heropost.secondary.button.color" description="Featured post buttons color (secondary)" type="color" default="#25a186"  value="#235b9a"/>
  <Variable name="heropost.secondary.dropcap.color" description="Featured post drop cap color (secondary)" type="color" default="$(heropost.secondary.button.color)"  value="#235b9a"/>
</Group>
...
<Group description="Header" selector=".centered-top-container">
  ...
  <Variable name="header.description.color" description="Description Color" type="color" default="rgba(0,0,0,0.54)"  value="rgba(0,0,0,0.537)"/>
  <Variable name="header.pages.color" description="Page list color" type="color" default="#25a186"  value="#235b9a"/>
  <Variable name="header.pages.selected.color" description="Page list color (selected page)" type="color" default="$(header.pages.color)"  value="#235b9a"/>
  <Variable name="header.items.color" description="Text color" type="color" default="#25a186"  value="#235b9a"/>
...
<Group description="Feed" selector=".widget.Blog">
  ...
  <Variable name="feed.title.color" description="Post title color" type="color" default="#25a186"  value="#235b9a"/>
  ...
  <Variable name="feed.subtitle.color" description="Post subtitle color" type="color" default="rgba(0,0,0,0.54)"  value="rgba(0,0,0,0.537)"/>
  <Variable name="feed.text.font" description="Post text font" type="font" default="$(loraNormal20)"  value="400 20px Lora, serif"/>
  <Variable name="feed.text.color" description="Post text color" type="color" default="rgba(0,0,0,0.84)"  value="rgba(0,0,0,0.839)"/>
  ...
  <Variable name="feed.button.color" description="Button color" type="color" default="#25a186"  value="#235b9a"/>
</Group>
...
<Group description="Sharing" selector=".sharing">
  ...
  <Variable name="sharing.text.color" description="Sharing text color"
      type="color"
      default="$(feed.button.color)"  value="#235b9a"/>
  <Variable name="sharing.icons.color"
      description="Sharing icons color"
      type="color"
      default="$(sharing.text.color)"  value="#235b9a"/>
</Group>
...
<Group description="Dialogs" selector=".subscribe-popup">
  ...
  <Variable name="dialog.action.color" description="Dialog action color" type="color" default="$(feed.button.color)"  value="#235b9a"/>
</Group>
            ...
            <div class='main_header_elements container'>
              ...
              <div class='blog-name'>
                <b:section id='header' name='Header' showaddelement='false'>
                  <b:widget id='Header1' locked='true' title='DIV TECH  (Header)' type='Header' visible='true'>
                    <b:widget-settings>
    ...
    <b:include name='searchSubmit'/>
          ...
          <nav role='navigation'>
            <b:section class='centered-top-secondline' id='page_list_top' name='Page List (Top)' showaddelement='false'>
              <b:widget id='PageList1' locked='true' title='DIV TECH' type='PageList' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='pageListJson'><![CDATA[{'0': {'href': 'https://bbconlineclasses.blogspot.com/', 'title': 'Home', 'position': 0}, 'link0': {'href': 'https://bbconlineclasses.blogspot.com/2021/01/about-us.html', 'title': 'About', 'position': 1}, 'link1': {'href': 'https://bbconlineclasses.blogspot.com/2021/01/function-validateformfrm-if-frm.html', 'title': 'Contact', 'position': 2}, 'link2': {'href': 'https://bbconlineclasses.blogspot.com/2021/01/privacy-policy.html', 'title': 'Privecy', 'position': 3}, 'link3': {'href': 'https://bbconlineclasses.blogspot.com/2021/01/terms-and-conditions.html', 'title': 'Terms and Conditions', 'position': 4}, 'link4': {'href': 'https://bbconlineclasses.blogspot.com/2021/01/disclaimer.html', 'title': 'Disclaimer', 'position': 5}}]]></b:widget-setting>
            ...
            <b:include cond='data:posts.any' data='{                                postDisplay: data:postDisplay,                                post: data:posts.first                              }' name='heroPost'/>
                    ...
                    <b:widget id='Blog1' locked='true' title='Blog Posts' type='Blog' visible='true'>
                      <b:widget-settings>
                        ...
                        <b:widget-setting name='style.textcolor'>#235b9a</b:widget-setting>
                        <b:widget-setting name='showShareButtons'>true</b:widget-setting>
                        <b:widget-setting name='showCommentLink'>true</b:widget-setting>
                        <b:widget-setting name='style.urlcolor'>#e4e9ef</b:widget-setting>
      ...
      <div id='comment-popup'>
        ...
        <aside class='sidebar-container sidebar-invisible' role='complementary'>
          ...
          <b:section class='sidebar' id='sidebar' name='Sidebar' preferred='yes'>
            <b:widget id='HTML3' locked='false' title='Google Ads' type='HTML' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='content'>&lt;script async src=&quot;https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6159847603119452&quot;
    ...
    <b:else/>
      <b:include name='defaultAdUnit'/>
          ...
          <b:with value='&quot;/* Done in css. */&quot;' var='style'>
            ...
            <b:widget id='LinkList1' locked='false' title='Css Options (Boxed and Snippet)' type='LinkList' visible='false'>
              <b:widget-settings>
   ...
   <ul>
     <b:loop values='data:links' var='link'>
       <li><a expr:href='data:link.target'><data:link.name/></a></li>
            ...
            <b:widget id='LinkList2' locked='false' title='Default Variables' type='LinkList' visible='false'>
              <b:widget-settings>
                ...
                <b:widget-setting name='link-0'>DIV TECH</b:widget-setting>
   ...
   <ul>
     <b:loop values='data:links' var='link'>
       <li><a expr:href='data:link.target'><data:link.name/></a></li>
            ...
            <b:widget id='LinkList3' locked='false' title='Link List' type='LinkList' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='sorting'>NONE</b:widget-setting>
   ...
   <ul>
     <b:loop values='data:links' var='link'>
       <li><a expr:href='data:link.target'><data:link.name/></a></li>
            ...
            <b:widget id='LinkList4' locked='false' title='' type='LinkList' visible='false'>
              <b:widget-settings>
   ...
   <ul>
     <b:loop values='data:links' var='link'>
       <li><a expr:href='data:link.target'><data:link.name/></a></li>
            ...
            <b:widget id='LinkList5' locked='false' title='Link List' type='LinkList' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='text-10'>_Web Documentation</b:widget-setting>
                <b:widget-setting name='sorting'>NONE</b:widget-setting>
                <b:widget-setting name='link-1'>#</b:widget-setting>
                <b:widget-setting name='link-2'>#</b:widget-setting>
                <b:widget-setting name='link-12'>https://www.soratemplates.com/2021/01/sora24-blogger-templates.html</b:widget-setting>
                <b:widget-setting name='link-0'>/</b:widget-setting>
                <b:widget-setting name='link-11'>https://youtu.be/uEPgIWhZclk</b:widget-setting>
                <b:widget-setting name='link-10'>https://www.sorabloggingtips.com/2021/01/how-to-setup-sora24-blogger-template.html</b:widget-setting>
                ...
                <b:widget-setting name='link-8'>https://sora24-soratemplates.blogspot.com/soratemplates</b:widget-setting>
                <b:widget-setting name='link-5'>#</b:widget-setting>
                <b:widget-setting name='link-6'>https://sora24-soratemplates.blogspot.com/p/post-format-and-page-markup_29.html</b:widget-setting>
                <b:widget-setting name='link-3'>#</b:widget-setting>
   ...
   <ul>
     <b:loop values='data:links' var='link'>
       <li><a expr:href='data:link.target'><data:link.name/></a></li>
            ...
            <b:widget id='HTML1' locked='false' title='Trending' type='HTML' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='content'>3/recent/ticker-posts</b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
            ...
            <b:widget id='LinkList6' locked='false' title='Social Plugin' type='LinkList' visible='false'>
              <b:widget-settings>
   ...
   <ul>
     <b:loop values='data:links' var='link'>
       <li><a expr:href='data:link.target'><data:link.name/></a></li>
            ...
            <b:widget id='HTML2' locked='false' title='Subscribe Us' type='HTML' version='2' visible='false'>
              <b:widget-settings>
    ...
    <data:content/>
            ...
            <b:widget id='Label2' locked='false' title='Categories' type='Label' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
                <b:widget-setting name='display'>LIST</b:widget-setting>
                <b:widget-setting name='selectedLabelsList'>Fashion,Music,Photography,Technology</b:widget-setting>
  ...
  <div class='widget-content'>
    ...
    <b:include cond='data:this.display == &quot;cloud&quot;' name='cloud'/>
          ...
          <b:include data='{                               buttonClass: &quot;flat-button&quot;,                               items: data:this.labels,                               itemSet: &quot;labels&quot;,                               itemsMarkup: &quot;super.list&quot;                             }' name='extendableItems'/>
            ...
            <b:widget id='PopularPosts2' locked='false' title='Most Popular' type='PopularPosts' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='numItemsToShow'>3</b:widget-setting>
                <b:widget-setting name='showThumbnails'>true</b:widget-setting>
                <b:widget-setting name='showSnippets'>true</b:widget-setting>
          ...
          <div class='post-outer-container'>
            ...
            <b:widget id='Label3' locked='false' title='Labels' type='Label' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
                <b:widget-setting name='display'>LIST</b:widget-setting>
                <b:widget-setting name='selectedLabelsList'>Beauty,Fashion,Food,Music,Nature,People,Photography,Sports,Technology</b:widget-setting>
                <b:widget-setting name='showType'>USER_SELECTED</b:widget-setting>
                <b:widget-setting name='showFreqNumbers'>true</b:widget-setting>
              </b:widget-settings>
              <b:includable id='main' var='this'>
  ...
  <div class='widget-content'>
    ...
    <b:include cond='data:this.display == &quot;cloud&quot;' name='cloud'/>
          ...
          <b:include data='{                               buttonClass: &quot;flat-button&quot;,                               items: data:this.labels,                               itemSet: &quot;labels&quot;,                               itemsMarkup: &quot;super.list&quot;                             }' name='extendableItems'/>
            ...
            <b:widget id='LinkList7' locked='false' title='Top Sites' type='LinkList' visible='false'>
              <b:widget-settings>
                <b:widget-setting name='link-3'>#</b:widget-setting>
                <b:widget-setting name='sorting'>NONE</b:widget-setting>
                <b:widget-setting name='link-4'>#</b:widget-setting>
